...
Good evening. My name is Toadchu Y'all.
...
[pause] I'm Toadchu Y'all. [pause] This is the Market Close.
[pause] Goodnight.
"""
...
def intro() -> str:
    ...
    template; the intro names Toadchu Y'all and the Market Close inside its own
